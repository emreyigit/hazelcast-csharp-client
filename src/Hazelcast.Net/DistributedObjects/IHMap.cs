...
namespace Hazelcast.DistributedObjects
{
    ...
    public partial interface IHMap<TKey, TValue> : IHMapBase<TKey, TValue>, IKeyLockable<TKey>, IQueryable<KeyValuePair<TKey, TValue>>, IOrderedQueryable<KeyValuePair<TKey, TValue>>
